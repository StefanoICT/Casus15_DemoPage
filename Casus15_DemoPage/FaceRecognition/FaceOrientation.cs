...
namespace Casus15_DemoPage.FaceRecognition
{
    public class FaceOrientation
    {
        ...
        public async Task DetectFaces() {
            ...
            faceList = await UploadAndDetectFaces("D:\\programming\\Face\\website\\Casus15_DemoPage\\Image\\image.jpg");
        ...
        // </snippet_facedesc>
        public Point CountFacesLookingAtScreen(DetectedFace face) {
